...
class Command(RunserverCommand):
    ...
    option_list += (make_option('--coffeescript', dest='coffescript_project_path',
        default=settings.COFFEE_SCRIPT_PROJECT_PATH,
        help='Specifies the project directory for a coffee-script project'),
    )
    ...
    def start_compass_watch(self):
        self.stdout.write(
            self.style.NOTICE(
                ">>> Starting the compass watch command for %r") % self.compass_project_path + "\n")
